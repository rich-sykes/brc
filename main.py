...
# aggregation filter  - asset class
...
# aggregation_level = 'instrument_asset_class'
# aggregation_level = 'instrument'
# aggregation_level = 'contract'

def agg_contracts(trade_data, contract_data, price_data, instrument_data, contract_tickers, current_date, aggregation_level):
    ...
    price_data = price_data[contract_tickers][price_data.index <= current_date]
